...
import { RssTrigger } from './rss/rss-trigger';
import type { StartTrigger } from './types';

export { TriggerRegistry } from './registry';
export * from './types';
export { stripTriPrefix, stripPrefix } from './attrs';
...
export { RssTrigger } from './rss/rss-trigger';
...
export function registerBuiltInTriggers(registry: TriggerRegistry): void {
  ...
  registry.register(new RssTrigger());
}
