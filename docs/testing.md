...
Tests use **Jest**. Some suites need a running **MongoDB** instance and variables from `.env` (see [Getting started](getting-started.md)). Collection and field reference: [Database schema (MongoDB)](database-schema.md).
